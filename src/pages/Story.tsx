  ...
  <div style="max-width:1200px;margin:0 auto;width:100%">
    ...
    <div class="s4-grid">
      ...
      <div class="serv-card" id="sv2">
        ...
        <a href="https://wa.me/919059252564?text=Hello Ansar Ahmed, I'm interested in your Commercial Spaces service." target="_blank" class="serv-wa-link" title="Contact on WhatsApp"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M21 11.5a8.38 8.38 0 0 1-.9 3.8 8.5 8.5 0 1 1-7.6-11.7 8.5 8.5 0 0 1 8.5 8.5c0 1.2-.3 2.3-.9 3.3L21 21l-5.6-1.1z"/></svg></a>
        <div class="serv-arrow"><svg viewBox="0 0 24 24"><line x1="7" y1="17" x2="17" y2="7"/><polyline points="7 7 17 7 17 17"/></svg></div>
        <div class="serv-bar"></div>
      </div>
      <div class="serv-card" id="sv3">
        ...
        <a href="https://wa.me/919059252564?text=Hello Ansar Ahmed, I'm interested in your Luxury Hospitality service." target="_blank" class="serv-wa-link" title="Contact on WhatsApp"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M21 11.5a8.38 8.38 0 0 1-.9 3.8 8.5 8.5 0 1 1-7.6-11.7 8.5 8.5 0 0 1 8.5 8.5c0 1.2-.3 2.3-.9 3.3L21 21l-5.6-1.1z"/></svg></a>
        <div class="serv-arrow"><svg viewBox="0 0 24 24"><line x1="7" y1="17" x2="17" y2="7"/><polyline points="7 7 17 7 17 17"/></svg></div>
        <div class="serv-bar"></div>
      </div>
      <div class="serv-card" id="sv4">
        ...
        <a href="https://wa.me/919059252564?text=Hello Ansar Ahmed, I'm interested in your Lighting Design service." target="_blank" class="serv-wa-link" title="Contact on WhatsApp"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M21 11.5a8.38 8.38 0 0 1-.9 3.8 8.5 8.5 0 1 1-7.6-11.7 8.5 8.5 0 0 1 8.5 8.5c0 1.2-.3 2.3-.9 3.3L21 21l-5.6-1.1z"/></svg></a>
        <div class="serv-arrow"><svg viewBox="0 0 24 24"><line x1="7" y1="17" x2="17" y2="7"/><polyline points="7 7 17 7 17 17"/></svg></div>
        <div class="serv-bar"></div>
      </div>
      <div class="serv-card" id="sv5">
        ...
        <a href="https://wa.me/919059252564?text=Hello Ansar Ahmed, I'm interested in your Material Curation service." target="_blank" class="serv-wa-link" title="Contact on WhatsApp"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M21 11.5a8.38 8.38 0 0 1-.9 3.8 8.5 8.5 0 1 1-7.6-11.7 8.5 8.5 0 0 1 8.5 8.5c0 1.2-.3 2.3-.9 3.3L21 21l-5.6-1.1z"/></svg></a>
        <div class="serv-arrow"><svg viewBox="0 0 24 24"><line x1="7" y1="17" x2="17" y2="7"/><polyline points="7 7 17 7 17 17"/></svg></div>
        <div class="serv-bar"></div>
      </div>
      <div class="serv-card" id="sv6">
        ...
        <a href="https://wa.me/919059252564?text=Hello Ansar Ahmed, I'm interested in your Bespoke Furniture service." target="_blank" class="serv-wa-link" title="Contact on WhatsApp"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M21 11.5a8.38 8.38 0 0 1-.9 3.8 8.5 8.5 0 1 1-7.6-11.7 8.5 8.5 0 0 1 8.5 8.5c0 1.2-.3 2.3-.9 3.3L21 21l-5.6-1.1z"/></svg></a>
        <div class="serv-arrow"><svg viewBox="0 0 24 24"><line x1="7" y1="17" x2="17" y2="7"/><polyline points="7 7 17 7 17 17"/></svg></div>
        <div class="serv-bar"></div>
      </div>
    </div>
