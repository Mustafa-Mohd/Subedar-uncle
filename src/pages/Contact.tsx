                ...
                <div className="flex flex-col gap-3 pt-2">
                  ...
                  <div className="flex items-center gap-4 p-4 rounded-xl bg-ivory dark:bg-white/5 border border-charcoal/5 dark:border-white/5 shadow-sm transition-all hover:shadow-md">
                    ...
                    <div>
                      ...
                      <p className="font-display text-base text-charcoal dark:text-white">2-46, Narsingi - Puppalaguda Main Rd, Anupama Homes, Manikonda, Hyderabad, Telangana 500089</p>
                    </div>
                  </div>
                </div>
              </div>
